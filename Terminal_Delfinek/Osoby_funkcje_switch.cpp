...
void switch_sekretarka(Sekretarka& sekretarka,Personel& personel) {
    int wybor;
    do {
        system("cls");
        ...
        std::cout << "5. Przeprowadz płatnosc" << std::endl;
        ...
        switch (wybor) {
            case 1:
                ...
                sekretarka.wprowadzDanePrzepracowanychGodzin(personel);
                system("pause");
                break;
            case 2:
                system("cls");
                personel.wyswietlOsoby();
                sekretarka.obliczWynagrodzenie(personel);
                system("pause");
                break;
            case 3:
                system("cls");
                personel.wyswietlOsoby();
                sekretarka.wprowadzPremie(personel);
                system("pause");
                break;
            case 4:
                system("cls");
                personel.wyswietlOsoby();
                sekretarka.zatwierdzWynagrodzenie(personel);
                system("pause");
                break;
            case 5:
                system("cls");
                personel.wyswietlOsoby();
                sekretarka.przeprowadzPlatnosc(personel);
                system("pause");
                break;
            case 6:
                system("cls");
                personel.wyswietlOsoby();
                sekretarka.ksiegujPlatnosc(personel);
                system("pause");
                break;
            case 7:
                system("cls");
